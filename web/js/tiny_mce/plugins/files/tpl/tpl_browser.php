...
<input type="hidden" id="folder" value="<?php echo $_SESSION['folder'] ?>" />
<div id="resizer"></div>
<div id="shadow"></div>
<div id="dialog"></div>
...
<div id="right">
    <div id="toolbar">
        ...
        <a href="kcact:upload"><?php echo $this->label("Subir archivo") ?></a>
        <a href="kcact:refresh"><?php echo $this->label("Actualizar") ?></a>
        <a href="kcact:settings"><?php echo $this->label("Configuraci&oacute;n") ?></a>
        <a href="kcact:maximize"><?php echo $this->label("Insertar") ?></a>
        <div id="loading"></div>
        </div>
    </div>
    <div id="settings">
