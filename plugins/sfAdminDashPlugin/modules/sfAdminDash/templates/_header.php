...
<?php if ($sf_user->isAuthenticated()): ?> 
  <div id='sf_admin_theme_header'>
    <a href='<?php echo url_for('homepage') ?>'><img height="40" src='/images/logo_in.png' /></a>
  </div>
  ...
  <div id='sf_admin_menu'>    
    ...
    <?php if (sfAdminDash::getProperty('logout') && $sf_user->isAuthenticated()): ?>
      <div id="logout"><a target="_blank" href="/"><img src="/sfAdminDashPlugin/images/homepage.png" />&nbsp;<?php echo __('Ver sitio'); ?></a> | <?php echo link_to(__('Logout', null, 'sf_admin_dash'), sfAdminDash::getProperty('logout_route', '@sf_guard_signout ')); ?> <?php echo $sf_user; ?></div>
    <?php endif; ?>
    <div class="clear"></div>
  </div>
